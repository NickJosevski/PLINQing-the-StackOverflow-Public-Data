...
AS
  ...
  SELECT *
  FROM   OPENROWSET(BULK 'D:\Development\_SO_Dump\badges.xml',SINGLE_BLOB) AS data
...
AS
  ...
  INSERT INTO #WorkingTable
  SELECT *
  FROM   OPENROWSET(BULK 'D:\Development\_SO_Dump\comments.xml',SINGLE_BLOB) AS data
...
(
  ...
  INSERT INTO #WorkingTable
  SELECT *
  FROM   OPENROWSET(BULK 'D:\Development\_SO_Dump\posts.xml',SINGLE_BLOB) AS data
...
AS
  ...
  INSERT INTO #WorkingTable
  SELECT *
  FROM   OPENROWSET(BULK 'D:\Development\_SO_Dump\users.xml',SINGLE_BLOB) AS data
...
AS
  ...
  INSERT INTO #WorkingTable
  SELECT *
  FROM   OPENROWSET(BULK 'D:\Development\_SO_Dump\votes.xml',SINGLE_BLOB) AS data
